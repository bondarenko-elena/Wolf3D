...
void	display_text(t_env *env)
{
	...
	mlx_string_put(env->mlx.mlx_init, env->mlx.window, 10, 60, 0xffffff, "On/Off music - M");
	mlx_string_put(env->mlx.mlx_init, env->mlx.window, 10, 70, 0xffffff, "On/Off textures - T");
}